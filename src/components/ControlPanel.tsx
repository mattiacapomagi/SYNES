...
export const ControlPanel = ({ 
  ...
  return (
    <div className="border border-white p-6 pt-20 md:pt-6 space-y-6 w-full h-full flex flex-col justify-between bg-black min-h-[300px]">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
            ...
            />
             ...
             <div className="pt-4 pl-4 border-l border-white/30 ml-2 mt-2">
                ...
                <div className="flex gap-2">
                    <input 
                        ...
                        className="flex-1 bg-transparent border-b border-white py-1 text-xs font-mono focus:outline-none uppercase placeholder:text-white/30"
                    />
                    <button 
                        onClick={handleSeedSubmit}
                        className="text-[10px] uppercase border border-white px-2 hover:bg-white hover:text-black transition-colors"
                    >
                        [ APPLY ]
                    </button>
                </div>
